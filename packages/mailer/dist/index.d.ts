...
export { MAILER_OPTIONS, MAILER_TRANSPORT_FACTORY, MAILER_TEMPLATE_RESOLVER, MAILER_QUEUE_OPTIONS, } from './constants/mailer.constant';
...
export { TemplateResolver, ResolvedTemplate, } from './interfaces/template-resolver.interface';
...
export { BatchMailOptions, BatchResult, BatchItemResult, } from './interfaces/batch-options.interface';
